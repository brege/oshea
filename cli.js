 ...
 * @version 1.5.2 // Version bump for yargs boolean flag fix
 * @date 2025-05-19
 */
            ...
            async (args) => {
                ...
                try {
                    ...
                    if (generatedPdfPath) {
                        ...
                        if (args.open && fullConfig.pdf_viewer) { // Use args.open
        ...
        .command(
            ...
            async (args) => {
                ...
                try {
                    ...
                    const knownGenerateOptions = ['pluginName', 'outdir', 'o', 'filename', 'f', 'open', 'config', 'help', 'h', 'version', 'v', '$0', '_'];
        ...
        .command(
            ...
            (y) => {
                ...
                .option("open", { // CHANGED from no-open
                    ...
                    type: "boolean",
                    default: false, // Default is NOT to open for batch command
                });
            },
            async (args) => {
                let fullConfig;
                ...
                try {
                    ...
                    const generatedPdfPaths = await exporter.exportAllPdfs(
                        ...
                        hugoExportRules,
                        fullConfig,
                        !args.open, // Pass the negation of 'open' to match exporter's 'noOpen' param
                        itemBasePluginPath
                    );

                    if (args.open && fullConfig.pdf_viewer && generatedPdfPaths.length > 0) { // Use args.open
