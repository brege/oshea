...
The testing framework currently provides these dimensions:
...
{
  {
  "/full/path/to/oshea/test/runners/linting/all-linting.test.js::Code Linters (Unit Tests) scripts/linting/code/ M.0.1.2 no-jsdoc should report jsdoc comment blocks": {
    "success_count": 6,
    "fail_count": 0,
    "first_seen": "2025-08-04T17:43:45.069Z",
    "last_run": "2025-08-06T04:55:07.965Z",
    "last_status": "passed",
    "last_duration": 331
  },
}
