...
const TEST_OUTPUT_DIR = path.join(os.tmpdir(), 'oshea-test-output', 'default-plugin-e2e');
...
describe('plugins/default (in-situ Self-Activation Test) .contract/test/default-e2e.test.js', function() {
  this.timeout(15000);
