...
The project includes a telemetry script, `test/scripts/test-watcher.js`, that provides a live-reloading experience for development. It watches the `src/` directory for changes and automatically runs the corresponding integration tests for the modified module.
...
**Current** (automatically generated)
