...
describe('E2E - Full User Workflow (Lifecycle)', function() {
  ...
  it('4.1.1: should handle the full lifecycle of adding, enabling, using, disabling, and removing a plugin collection', async () => {
    ...
    logger.info('  [Workflow 4.1.1] Step 1: Adding collection...');
    ...
    logger.info('  [Workflow 4.1.1] Step 2: Enabling plugin...');
    ...
    logger.info('  [Workflow 4.1.1] Step 3: Converting document with plugin...');
    ...
    logger.info('  [Workflow 4.1.1] Step 4: Disabling plugin...');
    ...
    logger.info('  [Workflow 4.1.1] Step 5: Removing collection...');
  ...
  it('4.1.2: should archetype a bundled plugin, add it as a new managed plugin, and use it for conversion', async () => {
    ...
    logger.info(`  [Workflow 4.1.2] Step 1: Creating archetype from bundled plugin '${sourcePluginName}'...`);
    ...
    logger.info('  [Workflow 4.1.2] Step 2: Adding new archetype as managed plugin...');
    ...
    logger.info('  [Workflow 4.1.2] Step 3: Converting document with new plugin...');
