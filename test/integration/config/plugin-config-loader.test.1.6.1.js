// test/integration/plugin-config-loader/plugin-config-loader.test.1.6.1.js
const { expect } = require('chai');
const sinon = require('sinon');
const PluginConfigLoader = require('../../../src/plugin_config_loader'); // Adjust path as needed for project root
