...
module.exports = [
  ...
  makeCmUtilsScenario({
    ...
    method: 'deriveCollectionName',
    description:
      'should correctly derive a sanitized name from a local path with .git suffix',
  ...
  makeCmUtilsScenario({
    ...
    method: 'deriveCollectionName',
    description:
      'should replace non-alphanumeric characters (excluding hyphens and underscores) with hyphens',
  ...
  makeCmUtilsScenario({
    ...
    method: 'deriveCollectionName',
    description:
      'should collapse multiple consecutive non-alphanumeric characters into a single hyphen',
  ...
  makeCmUtilsScenario({
    ...
    method: 'deriveCollectionName',
    description:
      'should remove leading/trailing hyphens resulting from sanitization',
  ...
  makeCmUtilsScenario({
    ...
    method: 'toPascalCase',
    description:
      'should handle strings with multiple consecutive hyphens by treating them as single delimiters',
  ...
  makeCmUtilsScenario({
    ...
    method: 'toPascalCase',
    description:
      'should handle strings that start with a capital letter but have hyphens',
    args: ['My-plugin-name'],
    expected: 'MyPluginName',
  }),
  makeCmUtilsScenario({
  ...
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a valid alphanumeric plugin name with hyphens',
    args: ['my-plugin-name'],
    expected: true,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a valid plugin name starting and ending with alphanumeric characters',
    args: ['plugin123'],
    expected: true,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a valid plugin name starting and ending with alphanumeric characters (number first)',
    args: ['123plugin'],
    expected: true,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a single alphanumeric character plugin name',
    args: ['a'],
    expected: true,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a single numeric character plugin name',
    args: ['1'],
    expected: true,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a plugin name with mixed case alphanumeric characters',
    args: ['MyPluginName'],
    expected: true,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return true for a plugin name with mixed case and hyphens',
    args: ['my-Plugin-Name'],
    expected: true,
  }),
  makeCmUtilsScenario({
  ...
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return false for plugin names with consecutive hyphens',
    args: ['my--plugin'],
    expected: false,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return false for plugin names with special characters (other than hyphen)',
    args: ['my_plugin'],
    expected: false,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return false for plugin names with special characters (exclamation mark)',
    args: ['my!plugin'],
    expected: false,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return false for plugin names with special characters (dot)',
    args: ['my.plugin'],
    expected: false,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return false for plugin names that do not start with alphanumeric characters',
    args: ['@plugin'],
    expected: false,
  }),
  makeCmUtilsScenario({
    ...
    method: 'isValidPluginName',
    description:
      'should return false for plugin names that do not end with alphanumeric characters',
    args: ['plugin@'],
    expected: false,
  }),
  makeCmUtilsScenario({
