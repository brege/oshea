// test/runners/integration/plugins/plugin-registry-builder.cm-manifests.manifest.js
...
module.exports = [
  ...
  {
    description:
      "1.2.21: Should skip plugins whose config_path doesn't exist and log a warning",
    methodName: '_getPluginRegistrationsFromCmManifest',
    methodArgs: ['/fake/cm/enabled.yaml', 'Test'],
    ...makeCmManifestScenario({
      enabledPlugins: [
      ...
      expectResult: {},
      expectLogs: [/Config path for CM-enabled plugin does not exist/],
    }),
  },
];
