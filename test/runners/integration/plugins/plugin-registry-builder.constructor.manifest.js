...
module.exports = [
  {
    description:
      '1.2.1: Should correctly initialize paths using default OS home directory',
    constructorArgs: [
    ...
    assert: async (builder, _mocks, constants, expect, logs) => {
      ...
      expect(builder.projectManifestBaseDir).to.equal(
        constants.FAKE_MANIFEST_DIR,
      );
      expect(builder.xdgBaseDir).to.equal(
        `${constants.FAKE_HOME_DIR}/.config/oshea`,
      );
  ...
  {
    description:
      '1.2.1: Should correctly initialize paths using the XDG_CONFIG_HOME environment variable when set',
    constructorArgs: [
      commonTestConstants.FAKE_PROJECT_ROOT,
      null,
      commonTestConstants.FAKE_MANIFEST_PATH,
  ...
  {
    description:
      '1.2.2: Should throw an error if projectRoot is not provided (null)',
    constructorArgs: [null, null, null, false, false, null, null],
    isNegativeTest: true,
  ...
  {
    description:
      '1.2.2: Should throw an error if projectRoot is not provided (undefined)',
    constructorArgs: [undefined, null, null, false, false, null, null],
    isNegativeTest: true,
    expectedErrorMessage:
      'PluginRegistryBuilder: projectRoot must be a valid path string.',
    assert: async (_builder, _mocks, _constants, _expect, _logs) => {},
  },
  {
    ...
    constructorArgs: [12345, null, null, false, false, null, null],
    isNegativeTest: true,
    expectedErrorMessage:
      'PluginRegistryBuilder: projectRoot must be a valid path string.',
    assert: async (_builder, _mocks, _constants, _expect, _logs) => {},
  ...
  {
    description:
      '1.2.3: Should determine cmCollRoot based on XDG_DATA_HOME when set',
    constructorArgs: [
      commonTestConstants.FAKE_PROJECT_ROOT,
      null,
      null,
  ...
  {
    description:
      '1.2.3: Should determine cmCollRoot based on OS default when XDG_DATA_HOME is not set (Linux)',
    constructorArgs: [
      commonTestConstants.FAKE_PROJECT_ROOT,
      null,
      null,
  ...
  {
    description:
      '1.2.3: Should determine cmCollRoot based on OS default when XDG_DATA_HOME is not set (Windows)',
    constructorArgs: [
      commonTestConstants.FAKE_PROJECT_ROOT,
      null,
      null,
