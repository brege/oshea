// test/runners/integration/plugins/plugin-registry-builder.resolve-plugin-config-path.manifest.js
require('module-alias/register');
const { pluginRegistryBuilderFactoryPath } = require('@paths');
const { makeResolveConfigPathScenario } = require(
...
module.exports = [
  {
    ...
    ...makeResolveConfigPathScenario({
      ...
      fileSystem: {
        '/path/to/aliased/dir/plugin-dir/plugin.config.yaml': {
          exists: true,
          isFile: true,
        },
      },
  ...
  {
    description:
      "1.2.8: Should resolve a tilde-prefixed raw path to an absolute path in the user's home directory",
    methodName: '_resolvePluginConfigPath',
    ...makeResolveConfigPathScenario({
