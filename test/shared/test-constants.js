...
const TEST_DIR = __dirname; // Assuming this file is in dev/test/
...
const TEST_OUTPUT_DIR_NAME = 'test_output'; // Used by setup/cleanup in run-tests.js
const TEST_OUTPUT_BASE_DIR = path.join(TEST_DIR, TEST_OUTPUT_DIR_NAME); // Used by many test cases

const HUGO_EXAMPLE_SOURCE_IN_EXAMPLES = path.join(EXAMPLES_DIR, 'hugo-example'); // For generate tests

const CREATED_PLUGINS_SUBDIR = 'created_plugins_test'; // For plugin create tests
const CREATED_PLUGINS_DIR = path.join(TEST_OUTPUT_BASE_DIR, CREATED_PLUGINS_SUBDIR); // For plugin create tests
